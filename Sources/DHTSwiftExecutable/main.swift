...
let addr1 = try SocketAddress(ipAddress: "10.183.73.92", port: 7004)
let addr2 = try SocketAddress(ipAddress: "10.183.204.125", port: 7004)
let addr3 = try SocketAddress(ipAddress: "10.183.118.213", port: 7004)
